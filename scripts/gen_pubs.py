...
PUBS = [
    ...
    # ----- POSTERS -----
    dict(id="P01", cat="Poster", title="Life is Mystery: Reweaving Ordinary Spaces into Fluid Ecologies of Enchantment",
         slug="life-is-mystery", img="life-is-mystery.jpg",
         authors="[Author list]",
         venue="<em>CHI Extended Abstracts</em>, 2026",
         abstract="<em>Extended abstract — abstract pending. Please contact the author for a copy.</em>",
    ...
    dict(id="P02", cat="Poster", title="Exploring Daily Applications of Wearable Galvanic Vestibular Stimulation via a Self-Customizable Toolkit",
         ...
         authors="[Author list]",
         venue="<em>Augmented Humans Conference (AHs)</em>, 2026",
         abstract="<em>Poster — abstract pending. Please contact the author for a copy.</em>",
         cta_label=None, cta_url=None),
    ...
    dict(id="P04", cat="Birds of a Feather", title="Birds of a Feather: Women in CG",
         ...
         authors="[Author list]",
         venue="<em>SIGGRAPH Asia 2024</em>",
         abstract="<em>Birds of a Feather session — please contact the author for further information.</em>",
         cta_label=None, cta_url=None),
